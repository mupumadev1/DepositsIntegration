...
class BankDetails(models.Model):
    ...
    account_name = models.CharField(max_length=255, unique=True, verbose_name='Account Name')
    vendor_id = models.CharField(max_length=255, unique=True, verbose_name='Vendor ID')
...
class ProcessedDeposits(models.Model):
    ...
    vendorid = models.CharField(max_length=255, blank=False, unique=True)
